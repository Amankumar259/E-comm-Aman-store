          ...
          <div className="bg-[#151515] p-3 mt-2 mb-2 rounded-md">
              ...
              {uniqueBrands?.map((brand) => (
                <div className="flex items-center mb-3" key={brand}>
                  <input
                    ...
                    className="w-4 h-4 text-pink-400 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label className="ml-2 text-sm font-medium text-white dark:text-gray-300">
                    {brand}
                  </label>
            ...
            <div className="p-3 w-[15rem]">
              <input
                ...
                className="w-full px-3 py-2 text-sm placeholder-gray-400 border rounded-lg focus:outline-none focus:ring focus:border-pink-300"
              />
            </div>

            <div className="p-3 pt-0">
              <button
                className="w-full border my-4 text-white py-1 rounded hover:bg-pink-600"
